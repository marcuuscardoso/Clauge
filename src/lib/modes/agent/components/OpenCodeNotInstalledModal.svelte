<script lang="ts">
  // "Install OpenCode" prompt — install commands sourced from
  // opencode.ai/docs (the official install page) so each OS surfaces
  // the recommended path. Windows recommends WSL; we still show the
  // native package managers as a fallback.
  ...
  async function openDocs() {
    try {
      ...
      await openUrl('https://opencode.ai/docs/');
    } catch (_) {}
  }
</script>
