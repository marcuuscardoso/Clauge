...
pub fn run() {
    ...
    builder
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            cloud::commands::ai_config_list,
            cloud::commands::ai_config_create,
            cloud::commands::ai_config_update,
            cloud::commands::ai_config_delete,
            cloud::commands::ai_config_set_default,
